...
Route::get('/login/admin', function () {
    return view('auth.login', ['roleLabel' => 'Admin']);
})->name('login.admin');

Route::get('/login/doctor', function () {
    return view('auth.login', ['roleLabel' => 'Doctor']);
})->name('login.doctor');

Route::get('/login/receptionist', function () {
    return view('auth.login', ['roleLabel' => 'Receptionist']);
})->name('login.receptionist');

Route::get('/login/patient', function () {
    return view('auth.login', ['roleLabel' => 'Patient']);
})->name('login.patient');
